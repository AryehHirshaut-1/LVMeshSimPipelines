...
general_path = "/users/alanh/Documents/CBLResearch-github/NHPipelineSingle/3D"
results_path = "MultiPhysicsResults"
...
def volume_extract(file_num, material_type):
    ...
    np.savetxt(f'{general_path}/lv_volumes_{file_num}.csv', np.array(volumes), fmt='%.2f')
    return volumes

# Plotting generated volume vs. time data
# (times will automatically adjust to the new, shorter length of volumes)
volumesFill = volume_extract(file_num, "NH")
