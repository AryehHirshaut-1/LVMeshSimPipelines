...
folderpath = Path("/users/alanh/Documents/CBLResearch-github/HOPipelineSingle/3D/MultiPhysicsResults")
...
for file_num in range(0, filecount):
    ...
    CSV_PATH = f"{GeneralFile}/3D/lv_volumes_{file_num}.csv"
    ...
    # --- Output ---
    OUTPUT_PATH = f"{GeneralFile}/0D/CSV/TPV_{file_num}.csv"
