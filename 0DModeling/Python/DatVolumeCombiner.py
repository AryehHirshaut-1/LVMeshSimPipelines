...
GeneralFile = "0DModeling/SampleInputData"

# --- .dat file (time + pressure), has a header line ---
DAT_PATH = f"{GeneralFile}/lv_pressure.dat"
...
CSV_PATH = f"{GeneralFile}/lv_volumes_0.csv"
...
# --- Output ---
OUTPUT_PATH = f"{GeneralFile}/time_pressure_volume.csv"
