...
for i in $(seq 0 $((N-1))); do
  sed "s/CASEID/${i}/g" lv_sim_ho_HPC.xml > "inputs/lv_sim_ho_case_${i}.xml"
done
echo "Wrote ${N} files to inputs/  (inputs/lv_sim_ho_case_0.xml .. inputs/lv_sim_ho_case_$((N-1)).xml)"
